...
<!-- 	<link rel="stylesheet" href="css/plyr.css">
	...
	<title>Deflix – Online Movies, TV Shows</title>

</head>
<body class="body">
   <%String name=request.getParameter("mid"); %>
	<% ArrayList<TvSeries> TvSeries=(ArrayList<TvSeries>)uploadDB. displayTvseriesNm(name); %>
				...
				<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
					<div class="card">
						<div class="card__cover">
							...
							<a href="singleepisodeview.jsp?id=<% out.print(mv.getId()); %>" class="card__play">
								<i class="icon ion-ios-play"></i>
							</a>
						</div>
						<div class="card__content">
							<h3 class="card__title"><a href="singleepisodeview.jsp?id=<% out.print(mv.getId()); %>"><% out.print(mv.getName());%>[S-<% out.print(mv.getSeason());%>:E-<% out.print(mv.getEpisode());%>]</a></h3>
							<span class="card__category">
								<a href="singleepisodeview.jsp?id=<% out.print(mv.getId()); %>">
									<%
