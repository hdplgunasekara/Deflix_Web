...
-Password-<input type="password" class="inputBox"  name="password" placeholder="Enter Password" id="id1" required >
...
<input type="submit" value="Add" class="signUpbBtn" onclick="callfunction(event)">
