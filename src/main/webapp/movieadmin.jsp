...
<% ArrayList<Movie> movie=(ArrayList<Movie>)uploadDB.displayMovieUn((String)session.getAttribute("adminun")); %>
    <!---------------------------Header--------------------------->
...
<td> <a href="view?id=<%out.print(mv.getId()); %>" class="upbtn3">view</a></td>
<td> <a href="movieupdate?id=<%out.print(mv.getId()); %>" class="upbtn2" >update</a></td>
<td> <a href="delete?id=<%out.print(mv.getId()); %>"  class="upbtn"  onclick="return confirm('Are you sure you want to delete? <%out.print(mv.getName()); %>');">delete</a></td>
</tr>
