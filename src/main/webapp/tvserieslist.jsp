...
<body class="body">
	...
	<% ArrayList<TvSeries> TvSeries=(ArrayList<TvSeries>)uploadDB.displayTvseriesName(); %>
				...
				<div class="col-6 col-sm-4 col-lg-3 col-xl-2">
					<div class="card">
						<div class="card__cover">
							<img src="<% out.print(mv.getPath()); %>" alt="" width="400" height="300">
							<a href="episodeslist.jsp?mid=<% out.print(mv.getName()); %>" class="card__play">
								<i class="icon ion-ios-play"></i>
							</a>
						</div>
						<div class="card__content">
							<h3 class="card__title"><a href="episodeslist.jsp?mid=<% out.print(mv.getName()); %>"><% out.print(mv.getName()); %></a></h3>
							<span class="card__category">
								<a href="episodeslist.jsp?mid=<% out.print(mv.getName()); %>">
									<%
