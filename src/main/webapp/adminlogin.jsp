        ...
        <div class="signUp_Box">
            <div class="box">
                ...
                <form method="post" action="admin" >
                    <input type="text" placeholder="Admin Username" class="inputBox" name="adminun" required>
                    <input type="password" placeholder="Admin Passwrod" class="inputBox" name="adminpw" required>
