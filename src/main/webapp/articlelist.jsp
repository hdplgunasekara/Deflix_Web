					...
					<div class="col-12">
						<div class="header__content">
							...
							<div class="header__auth">
								...
								<a href="user?command=ACCOUNT&UserId=<%= request.getParameter("UserId")%>" class="header__sign-in" id="signin">
			...
			<div class="row">
				<div class="col-12">
					<div class="section__wrap">
						<!-- section title -->
						<h2 class="section__title">Articals</h2>
						<!-- end section title -->

						<!-- breadcrumb -->
						<ul class="breadcrumb">
							<li class="breadcrumb__item"><a href="index.jsp">Home</a></li>
							<li class="breadcrumb__item breadcrumb__item--active">Articals</li>
						</ul>
						<!-- end breadcrumb -->
					</div>
				</div>
							...
							<div class="col-12 col-sm-8">
								<div class="card__content">
									...
									<span class="card__category">
										...
										<a href="singlearticle.jsp?articleid=<% out.print(mv.getID()); %>"><% out.print(mv.getCategory()); %></td></a>
									...
									<div class="card__description">
										<p><% out.print(description.substring(0,50)); %>....</p>
									</div>
									<%}else{ %>
									<div class="card__description">
										<p><% out.print(mv.getDescription()); %>....</p>
									</div>
									<%} %>
								</div>
							</div>
