         ...
         <ul class="navigationL">
           <li><a  href="authorhome.jsp">Home</a></li>
               <li><a  href="Add_article_UI.jsp">Add Article</a></li>
                <li><a  href="Article.jsp">Article List</a></li> <li>
...
<form action="add" method="post">
    Name        : <input type="text" name="name" class="inputBox"  required><br>
    Rating      : <input type="text" name="rating" class="inputBox" required><br>
Category    : <input type="text" name ="category" class="inputBox" required>
               <br>
Description : 
<textarea class="inputBox" style=" height: 200px" name="description" required></textarea>
<input type="submit" name="submit" value="Add Article" class="signUpbBtn"> <br>
</form>
  </div>
        </div>
