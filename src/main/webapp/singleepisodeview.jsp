...
<%  TvSeries mv=uploadDB.getEpisode(id);%>
	...
	<section class="section details">
		...
		<div class="container">
			<div class="row">
				<!-- title -->
				<div class="col-12">
					<h1 class="details__title"><% out.print(mv.getName()); %>[S-<% out.print(mv.getSeason()); %>:E-<% out.print(mv.getEpisode()); %>]</h1>
				</div>
				<!-- end title -->
						...
						<div class="row">
							...
							<div class="col-12 col-sm-8 col-md-8 col-lg-9 col-xl-7">
								<div class="card__content align-middle">
									...
									<ul class="card__meta">
										<li><span>Season:</span> <a href="#"><% out.print(mv.getSeason()); %></a> </li>
										<li><span>Episode:</span> <a href="#"><% out.print(mv.getEpisode()); %></a> </li>
